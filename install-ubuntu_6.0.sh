...
pip install itsdangerous==0.24 -i https://mirrors.aliyun.com/pypi/simple/
pip install paramiko==2.0.2 -i https://mirrors.aliyun.com/pypi/simple/
pip install flask-socketio==3.0.2 -i https://mirrors.aliyun.com/pypi/simple/
pip install python-socketio==2.1.2 -i https://mirrors.aliyun.com/pypi/simple/
...
do
	pip install ${p_name} -i https://mirrors.aliyun.com/pypi/simple/
done

pip install psutil chardet virtualenv Flask Flask-Session Flask-SocketIO flask-sqlalchemy Pillow gunicorn gevent-websocket paramiko  -i https://mirrors.aliyun.com/pypi/simple/
Install_Pillow
Install_psutil
...
pip install psutil chardet psutil virtualenv $pipArg -i https://mirrors.aliyun.com/pypi/simple/
