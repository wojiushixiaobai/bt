...
RUN set -ex \
    && apt-get update \
    && apt-get -y install wget curl zip unzip openssh-client python-pip build-essential libtool libpcre3 libpcre3-dev zlib1g-dev openssl libzip-dev cmake libncurses5-dev \
